...
DR<-distributiveRatioFromHdHisto(sp,st.sqr70,pt.sf,hd,nRowMap=NA,nColMap=NA,degPerBin=10)
print(DR)
```

If you want to see the code, have a look at the code in distributiveRationFromHdHisto().
