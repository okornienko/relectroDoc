...
Before starting the analysis on a group of recording sessions, it is a good practice to first ensure that the recording protocol used in each recording session is what you expect. Use the `RecSessionListTrialPlot` function.
...
You mainly gain time when analysis requires heavy CPU usage (e.g. if you calculate instantaneous firing rate).
