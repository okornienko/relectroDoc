...
Clusters that are not well isolated should be deleted. Quality is more important than quantity because your assumption when doing analysis is that a cluster represent all and only the spikes of one neuron.
