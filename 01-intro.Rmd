...
It has excellent support for statistical analysis and it can generate pretty nice figures.

It's main disadvantages are that it is pretty slow when compared to c programs, and some calculations are not easily done with the R language. 
...
We want to solve every bug once, and the next user should benefit from it. 
...
If you have no experience with R, I recommand doing a couple of tutorials online.
