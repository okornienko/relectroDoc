...
spikeTimeAutocorrelationsPlot(autos = st@auto, names = st@cellList, timePoints = st@autoTimePoints)
```
...
spikeTimeAutocorrelationPlot(x=st@crossTimePoints,y=st@cross[,6],type='h',name=paste("Pair:",st@cellPairList[6,1],st@cellPairList[6,2]))
```
